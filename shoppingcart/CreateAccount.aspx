<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="CreateAccount.aspx.cs" Inherits="CreateAccount" %>
...
<body>
        ...
        <asp:CreateUserWizard ID="CreateUserWizard1" runat="server" ContinueDestinationPageUrl="~/CreateAccount.aspx"
            Style="z-index: 100; left: 30px; position: absolute; top: 40px" >
            <WizardSteps>
